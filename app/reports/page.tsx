            ...
            <DashboardLayout>
                <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center">
                    <div className="bg-white p-8 rounded-2xl max-w-md shadow-lg">
                        ...
                        <Button asChild size="lg" className="bg-[var(--primary-teal)] hover:bg-[var(--primary-teal-dark)] text-white">
                            ...
                            {data.assessments.map((assessment) => (
                                <div
                                    ...
                                    className={`p-4 rounded-xl cursor-pointer transition-all border ${selectedAssessmentId === assessment.id
                                        ? "bg-white border-[var(--primary-teal)] shadow-md"
                                        : "bg-white border-gray-200 hover:border-[var(--primary-teal-light)]"
                                        }`}
                                >
                            ...
                            {(!selectedAssessment.actionPlan || selectedAssessment.actionPlan.length === 0) ? (
                                <div className="text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-200">
                                    ...
                                    <p className="text-gray-500 max-w-md mx-auto mt-2">
                                        Your facility appears to be in good standing. Continue monitoring and maintaining your resilience measures.
                                    </p>
                                </div>
                            ) : (
